...
public class Usuarios extends JFrame {
    ...
    public Usuarios(menuPrincipal MenuPrincipal) {
        ...
        JLabel buscarUsuarioLabel = new JLabel("Buscar Usuario");
        buscarUsuarioLabel.setForeground(new Color(255, 255, 255));
        buscarUsuarioLabel.setBounds(177, 117, 121, 25);
        panel.add(buscarUsuarioLabel);
        
        // Campo de texto para buscar productos
        JTextField buscarUsuarioField = new JTextField();
        buscarUsuarioField.setBounds(177, 142, 293, 30);
