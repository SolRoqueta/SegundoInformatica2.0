...
public class modificarMenuFijo extends JFrame {
    ...
    public modificarMenuFijo(menuMenuFijo MenuFijo) {
        ...
        precioField.setBounds(52, 302, 150, 25);
        ...
        descripcionLabel.setBounds(52, 335, 100, 25);
        panel.add(descripcionLabel);
        
        JTextArea descripcionArea = new JTextArea();
        descripcionArea.setBounds(52, 364, 150, 75);
